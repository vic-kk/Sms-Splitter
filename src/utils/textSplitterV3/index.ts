...
const checkMax = (smsCount: number = 0, limit:number = MAX_SMS_COUNT) => {
  if (smsCount > limit) {
...
const initialConfig = async (totalTextLenght:number = 0, maxSmsLength:number = MAX_SMS_LENGTH) => {
